<template>
  <IonPage>
    <IonHeader>
      <IonToolbar>
        <IonTitle> Add a car</IonTitle>
      </IonToolbar>
    </IonHeader>
    <IonContent :fullscreen="true">
      <IonHeader collapse="condense">
        <IonToolbar> <IonTitle> Add a car </IonTitle> </IonToolbar>
      </IonHeader>
...
import { CarCreateDto } from "@/models/Car";
...
const car = ref<CarCreateDto>({ header: "", content: "" });
